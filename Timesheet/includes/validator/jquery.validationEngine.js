    ...
    var methods = {
		...
		*/
        ...
        hideAll: function() {
            ...
            $('.validator-show').removeClass('validator-show');
            $('.validator-green').removeClass('validator-green');
            return this;
        },
        /**
		...
		*/
        _buildPrompt: function(field, promptText, type, ajaxed, options) {
            ...
            switch (type) {
                case "pass":
                    field.parent().addClass('validator-green');
                    prompt.addClass("greenPopup");
                    break;
                case "load":
                    field.parent().addClass('validator-black');
            ...
            field.before(prompt);
            field.parent().addClass('validator-show');
            ...
            if (options.autoHidePrompt) {
                setTimeout(function(){
                    prompt.animate({
                        ...
                        prompt.remove();
                        field.parent().removeClass('validator-green');
                        field.parent().removeClass('validator-black');
                        field.parent().removeClass('validator-show');
                    });
		...
		*/
        _updatePrompt: function(field, prompt, promptText, type, ajaxed, options, noAnimation) {
            field.parent().removeClass('validator-green');
            field.parent().removeClass('validator-red');
            field.parent().removeClass('validator-black');
            if (prompt) {
