<!--<div align="center"><br />
<br />
<a href="approval/all" style="color:#FFF"><button style="width:150px; height:45px"><strong style="font-size:16px">All List</strong></button></a> 
</div>-->
...
<form action="historyapproval/list" method="POST">
...
<table cellspacing="0">
	  ...
	  <tr>
						...
						<td><?= $hist['end_time']; ?></td>
						<td><?
					if(strtotime($hist['end_time'])>strtotime($hist['start_time'])){
					$time = strtotime($hist['end_time']) - strtotime($hist['start_time']);
					echo time_elapsed_A($time);}
					
					if(strtotime($hist['end_time'])<strtotime($hist['start_time'])){
					$time = (strtotime($hist['start_time']) - strtotime($hist['end_time']));
                ...
                ?></td>
						...
						<td><?if($hist['status']=='Rejected'){
								echo "<img src='images/x.jpg' width='18' height='18' title='Rejected' />";
							}
							else if($hist['status']=='Approved'){
								echo "<img src='images/v.jpg' width='18' height='18' title='Approved' />";
							}
							else
								echo "<img src='images/waiting.png' width='18' height='18' title='Waiting HR Approval' />";
						?> <?= $sheet['status'] ?></td>
						<td><form action="historyapproval/cancel" method="POST" id="cancel" onsubmit="return confirm('Are you sure you want to cancel this approved timesheet?');">
						<input type="hidden" name="timesheet_id" id="timesheet_id" value="<?php echo $hist['timesheetID'];?>"/>
