	...
	<span>
        ...
        <table width="200" border="1">
		   ...
		   <?IF($this->pmoResult>0) { ?>
			...
			<? IF($this->pmoResult>0 OR ($this->user->types != 1 AND $this->user->types != 2)) { ?>	
...
<table cellspacing="1" class="">
	...
	<tr>
		...
		<td><?if($sheet['status']=='Rejected'){
						...
						?></td>
		<?if ($this->user->types == 3) { ?>
	   <td style="vertical-align: middle; "><b class="iframe" href="<?= $this->config->baseHref; ?>claim/edit/id/<?= $sheet['claimID']; ?>/?iframe=true" title="Edit" data-id="<?= $sheet['claimID']; ?>"><img src="images/pencil.png"/></b></td>		
